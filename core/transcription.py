...
class ApiTranscriptionModel(TranscriptionModel):
    def __init__(self):
        ...
        self.silence_threshold = int(os.getenv("SILENCE_THRESH", -40))  # 修正为threshold
    ...
    def _transcribe_single_chunk(self, chunk_info: Tuple[str, float, float]) -> Tuple[float, float, str]:
    ...
    def transcribe(self, audio_path: str) -> List[List[Any]]:
        ...
        # 清理临时文件
        import shutil
        shutil.rmtree(self.temp_dir, ignore_errors=True)  # 添加ignore_errors避免目录已被删除的错误
